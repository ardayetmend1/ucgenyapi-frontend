    ...
    <footer className="footer">
      ...
      <div className="footer__top">
        ...
        <div className="footer__brand">
          <div className="footer__logo">
            ...
            <div className="footer__logo-text">
              <span>Ucgen</span> Yapi
            </div>
          </div>
          <p className="footer__slogan">
            Modern mimariyi doganin huzuruyla birlestiriyoruz.
            25 yili askin tecrubemizle yasam alanlari insa ediyoruz.
          </p>
        ...
        <div className="footer__col">
          <h4 className="footer__col-title">Hizli Erisim</h4>
        ...
        <div className="footer__col">
          ...
          <ul className="footer__links">
            <li><a href="#projeler">Ucgen Yasam Konutlari</a></li>
            <li><a href="#projeler">Ucgen Yasam Konutlari 2</a></li>
          </ul>
        </div>

        {/* Contact Info */}
        <div className="footer__col">
          <h4 className="footer__col-title">Iletisim</h4>
          <ul className="footer__contact">
            ...
            <li>
              ...
              <a href="tel:+903121234567">0 (312) 123 45 67</a>
            </li>
            <li>
              <span className="footer__contact-icon">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
              ...
              <a href="mailto:info@ucgenyapi.com">info@ucgenyapi.com</a>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="footer__bottom">
        ...
        <div className="footer__bottom-content">
          <p className="footer__copyright">
            &copy; {new Date().getFullYear()} Ucgen Yapi. Tum haklari saklidir.
          </p>
